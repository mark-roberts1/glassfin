...
Map<String, Object?> buildDeviceProfile({
  ...
  'DirectPlayProfiles': _directPlayProfiles(video),
  'ResponseProfiles': const <Object?>[],
  'ContainerProfiles': const <Object?>[],
  'CodecProfiles': _codecProfiles(video),
...
List<Map<String, Object?>> _directPlayProfiles(VideoSettings settings) => [
  {'Type': 'Audio'},
  {'Type': 'Photo'},
  if (!settings.alwaysForceTranscode) {'Type': 'Video'},
];

List<Map<String, Object?>> _transcodingProfiles(
  VideoSettings video,
  AudioSettings audio,
) => [
  {'Type': 'Audio'},
  {
    ...
    'VideoCodec': transcodeVideoCodecs(video),
    'MaxAudioChannels': audio.channels == AudioChannels.stereo ? '2' : '6',
  },
...
String transcodeVideoCodecs(VideoSettings settings) {
...
List<Map<String, Object?>> _codecProfiles(VideoSettings settings) => [
